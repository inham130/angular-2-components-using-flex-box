...
export const Stocks: Stock[] = [
    {date: new Date("2010-01-19"), value: 123},
    {date: new Date("2010-01-20"), value: 125},
    {date: new Date("2010-01-21"), value: 139},
    {date: new Date("2010-01-22"), value: 142},
    {date: new Date("2010-01-23"), value: 141},
    {date: new Date("2010-01-24"), value: 140},
    {date: new Date("2010-01-25"), value: 137},
    {date: new Date("2010-01-26"), value: 140},
    {date: new Date("2010-01-27"), value: 142},
    {date: new Date("2010-01-28"), value: 139},
    {date: new Date("2010-01-29"), value: 136},
    {date: new Date("2010-01-30"), value: 141},
    {date: new Date("2010-01-31"), value: 140},
    {date: new Date("2010-02-01"), value: 139},
    {date: new Date("2010-02-02"), value: 140},

    {date: new Date("2010-02-03"), value: 140},
    {date: new Date("2010-02-04"), value: 138},
    {date: new Date("2010-02-05"), value: 139},
    {date: new Date("2010-02-06"), value: 142},
    {date: new Date("2010-02-07"), value: 138},
    {date: new Date("2010-02-08"), value: 143},
    {date: new Date("2010-02-09"), value: 144},
    {date: new Date("2010-02-10"), value: 146},
    {date: new Date("2010-02-11"), value: 142},
    {date: new Date("2010-02-12"), value: 138},
    {date: new Date("2010-02-13"), value: 136},
    {date: new Date("2010-02-14"), value: 140},
    {date: new Date("2010-02-15"), value: 140},
    {date: new Date("2010-02-16"), value: 139},
    {date: new Date("2010-02-17"), value: 140},
  /*{date: new Date("2010-01-01"), value: 210.73},
  {date: new Date("2010-01-04"), value: 208},
